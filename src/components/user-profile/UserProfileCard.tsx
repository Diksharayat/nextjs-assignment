...
const UserProfileCard: React.FC = () => {
  ...
  {/* Header: Match Notes + Edit */}
  <div className="flex justify-between items-center py-2 px-4">
    <h3 className="font-semibold text-lg text-gray-800">Match Notes</h3>
  ...
  <div  >
    <p className="text-gray-500 p-4 mb-8">
      Lorem ipsum dolor sit am consectetur adipiscing elit, sed eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.
    </p>
  </div>
</div>
...
<div className="bg-white rounded-xl text-sm text-gray-700">
  ...
  <div className="p-4 mb-8 text-gray-500">
    <table className="w-full">
      ...
      <div className="bg-white rounded-xl text-sm text-gray-700">
  {/* Header: Self Descriptions + Edit */}
  <div className="flex justify-between items-center py-2 px-4">
    <h3 className="font-semibold text-lg text-gray-800">Self Descriptions</h3>
    <div className="bg-gray-200 p-2 rounded-md">
      <Edit2 size={15} />
    </div>
  </div>
...
<div className="bg-white rounded-xl text-sm text-gray-700">
  {/* Header */}
  <div className="flex justify-between items-center py-2 px-4">
    <h3 className="font-semibold text-lg text-gray-800">Interest</h3>
